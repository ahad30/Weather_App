...
const HomePage = () => {
  ...
  return (
    <div className="p-6 mb-10 max-w-lg mx-auto mt-10 bg-gradient-to-br from-blue-100 via-white to-blue-50 shadow-2xl rounded-2xl transition-all duration-300">
     <div className="flex justify-between items-center mb-5">
     <h1 className="text-lg lg:text-2xl font-bold text-center  text-blue-700">
      Weather Finder
    </h1>
    <ToggleButton />
     </div>
    ...
    {!isLoading && (
      <div className="mt-6 bg-white border border-blue-100 rounded-xl p-6 shadow-inner transition-all duration-300">
        {isError ? (
          <p className="text-center text-red-500 font-bold">No City Found</p>
        ) : data ? (
          <div className="flex flex-col items-center">
            ...
            <p className="text-5xl font-bold text-blue-500 my-3">
